...
const SubscriptionPlans = () => {
  ...
  const loadPlans = async () => {
    try {
      ...
      const [plansResponse, subscriptionsResponse] = await Promise.all([
        ...
        studentDashboardAPI.getSubscriptions().catch(() => ({ subscriptions: [] })),
      ]);
  ...
  if (loading) {
    return (
      <div className="org-ex-enroll-page org-plans-page stu-plans-page">
    ...
    <div className="org-ex-enroll-page org-plans-page stu-plans-page">
      <div className="page-header org-ex-enroll-header org-plans-header">
        <div>
          ...
          <p className="page-subtitle">
            Plans for individual learners. Subscribe with your student account to unlock exams and practice features.
          </p>
        </div>
      </div>
      ...
      {plans.length === 0 ? (
        <div className="org-ex-enroll-panel org-plans-empty">
          ...
          <p className="org-ex-enroll-panel-hint">Please contact support for subscription options.</p>
        </div>
...
function PlanCard({ plan, onDetails, onSubscribe, onUnsubscribe }) {
  ...
  return (
    <article className={`org-plans-card org-plans-card--${status}`} aria-label={`${plan.PlanName} plan`}>
        ...
        <div className="org-plans-modal-body">
          <div className="org-plans-unsub-warning">
            ...
            <ul className="org-plans-unsub-list">
              ...
              <li>
                <XCircle size={14} />
                You may lose access to plan exams and practice features
              </li>
              <li>
                <XCircle size={14} />
                School assignments (if any) are unchanged
              </li>
              ...
              <div className="org-plans-exam-list">
                {plan.exams.map((exam) => (
                  <div key={exam.ExamID} className="org-plans-exam-item">
                    ...
                    {exam.ExamDescription && <p className="org-ex-enroll-meta">{exam.ExamDescription}</p>}
